 ...
 * @since 3.1
 */
public abstract class TicketValidator extends
	 ...
	 */
	public String httpRequest(String validationUrl) {
		...
		try {
			...
			connection = (HttpURLConnection) new URL(validationUrl).openConnection();
